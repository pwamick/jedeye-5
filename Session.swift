...
class Session : NSObject {
    ...
    static func percentEncode(_ this:String) -> String {
        /*
        let buf : [UInt16] = Array(this.utf16)
        print("&&&buf = \(buf)")
        print("&&&this = \(this)")
        */
        var retVal = this.replacingOccurrences(of: "%", with: "%25")
        retVal = retVal.replacingOccurrences(of: " ", with: "%20")
        retVal = retVal.replacingOccurrences(of: "!", with: "%21")
        retVal = retVal.replacingOccurrences(of: "#", with: "%23")
        retVal = retVal.replacingOccurrences(of: "$", with: "%24")
        //retVal = retVal.replacingOccurrences(of: "&", with: "%26")
        retVal = retVal.replacingOccurrences(of: "'", with: "%27")
        retVal = retVal.replacingOccurrences(of: "\u{2019}", with: "%27")
        retVal = retVal.replacingOccurrences(of: "(", with: "%28")
        retVal = retVal.replacingOccurrences(of: ")", with: "%29")
        retVal = retVal.replacingOccurrences(of: "*", with: "%2A")
        //retVal = retVal.replacingOccurrences(of: "+", with: "%2B")
        retVal = retVal.replacingOccurrences(of: ",", with: "%2C")
        retVal = retVal.replacingOccurrences(of: ".", with: "%2E")
        retVal = retVal.replacingOccurrences(of: "/", with: "%2F")
        //retVal = retVal.replacingOccurrences(of: ":", with: "%3A")
        //retVal = retVal.replacingOccurrences(of: ";", with: "%3B")
        //retVal = retVal.replacingOccurrences(of: "=", with: "%3D")
        //retVal = retVal.replacingOccurrences(of: "?", with: "%3F")
        retVal = retVal.replacingOccurrences(of: "@", with: "%40")
        //retVal = retVal.replacingOccurrences(of: "[", with: "%5B")
        //retVal = retVal.replacingOccurrences(of: "]", with: "%5D")
        return retVal
    }
 }
